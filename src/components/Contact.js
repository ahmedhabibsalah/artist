...
import { animationTwo } from '../animations';
 ...
 const Contact = () => {
    ...
    return (
        ...
        <div class="relative flex items-top justify-center min-h-screen  dark:bg-gray-900 sm:items-center sm:pt-0" style={{backgroundColor:"#263C41"}}>
            ...
            <div class="mt-8 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <form class="p-6 flex flex-col justify-center" ref={form}  onSubmit={sendEmail}>
                        ...
                        <input type="submit" class="md:w-32 bg-red-600 hover:bg-red-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-red-500 transition ease-in-out duration-300" style={{backgroundColor:"#5C4D3C", cursor:"pointer"}}
                            Submit />
